...
PARTS = {
     ...
     29: Part("EFR32MG12B",  0x400E0000, EfmFlash),
     30: Part("EFR32MG12V",  0x400E0000, EfmFlash),
     31: Part("EFR32BG12P",  0x400E0000, EfmFlash),
     32: Part("EFR32BG12B",  0x400E0000, EfmFlash),
     33: Part("EFR32BG12V",  0x400E0000, EfmFlash),
     37: Part("EFR32FG12P",  0x400E0000, EfmFlash),
     38: Part("EFR32FG12B",  0x400E0000, EfmFlash),
     39: Part("EFR32FG12V",  0x400E0000, EfmFlash),
     40: Part("EFR32MG13P",  0x400E0000, EfmFlash),
     41: Part("EFR32MG13B",  0x400E0000, EfmFlash),
     42: Part("EFR32MG13V",  0x400E0000, EfmFlash),
     43: Part("EFR32BG13P",  0x400E0000, EfmFlash),
     44: Part("EFR32BG13B",  0x400E0000, EfmFlash),
     45: Part("EFR32BG13V",  0x400E0000, EfmFlash),
     46: Part("EFR32ZG13P",  0x400E0000, EfmFlash),
     49: Part("EFR32FG13P",  0x400E0000, EfmFlash),
     50: Part("EFR32FG13B",  0x400E0000, EfmFlash),
     51: Part("EFR32FG13V",  0x400E0000, EfmFlash),
     52: Part("EFR32MG14P",  0x400E0000, EfmFlash),
     53: Part("EFR32MG14B",  0x400E0000, EfmFlash),
     54: Part("EFR32MG14V",  0x400E0000, EfmFlash),
     55: Part("EFR32BG14P",  0x400E0000, EfmFlash),
     56: Part("EFR32BG14B",  0x400E0000, EfmFlash),
     57: Part("EFR32BG14V",  0x400E0000, EfmFlash),
     58: Part("EFR32ZG14P",  0x400E0000, EfmFlash),
     61: Part("EFR32FG14P",  0x400E0000, EfmFlash),
     62: Part("EFR32FG14B",  0x400E0000, EfmFlash),
     63: Part("EFR32FG14V",  0x400E0000, EfmFlash),
     ...
     81: Part("EFM32PG1B",   0x400E0000, EfmFlash),
     83: Part("EFM32JG1B",   0x400E0000, EfmFlash),
     85: Part("EFM32PG12B",  0x400E0000, EfmFlash),
     87: Part("EFM32JG12B",  0x400E0000, EfmFlash),
    100: Part("EFM32GG11B",  0x40000000, Efm1GFlash),
    103: Part("EFM32TG11B",  0x40000000, Efm1GFlash),
    106: Part("EFM32GG12B",  0x40000000, Efm1GFlash),
    120: Part("EZR32LG",     0x400C0000, EfmFlash),
    121: Part("EZR32WG",     0x400C0000, EfmFlash),
