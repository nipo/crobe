...
architecture arch of i2c_master is
  ...
  signal s_i2c_cmd, s_i2c_rsp : nsl.framed.framed_bus;
  signal s_routed_i2c_cmd, s_routed_i2c_rsp : nsl.routed.routed_bus;
...
--      p_sda => dbg_tms,
  ...
  cmd_router: nsl.routed.routed_router
    ...
    port map(
      ...
      p_out_val(0) => s_routed_i2c_cmd.req,
      p_out_val(1) => s_routed_cs_cmd.req,

      p_out_ack(0) => s_routed_i2c_cmd.ack,
  ...
  rsp_router: nsl.routed.routed_router
    ...
    port map(
      ...
      p_in_val(0) => s_routed_i2c_rsp.req,
      p_in_val(1) => s_routed_cs_rsp.req,

      p_in_ack(0) => s_routed_i2c_rsp.ack,
  ...
  i2c_endpoint: nsl.routed.routed_endpoint
    port map(
      ...
      p_cmd_in_val => s_routed_i2c_cmd.req,
      p_cmd_in_ack => s_routed_i2c_cmd.ack,
      p_rsp_out_val => s_routed_i2c_rsp.req,
      p_rsp_out_ack => s_routed_i2c_rsp.ack,
