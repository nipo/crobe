...
<drawing version="7">
    ...
    <netlist>
        ...
        <port polarity="Input" name="Activity" />
        <port polarity="Output" name="Activity_LED" />
        <blockdef name="ibuf">
        ...
        <block symbolname="ibuf" name="XLXI_533">
            <blockpin signalname="Activity" name="I" />
            <blockpin signalname="XLXN_508" name="O" />
        </block>
        <block symbolname="obuf" name="XLXI_534">
            <blockpin signalname="XLXN_508" name="I" />
            <blockpin signalname="Activity_LED" name="O" />
        </block>
    </netlist>
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="Activity">
            <wire x2="2368" y1="1440" y2="1440" x1="2176" />
            <wire x2="2384" y1="1440" y2="1440" x1="2368" />
        </branch>
        <instance x="2384" y="1472" name="XLXI_533" orien="R0" />
        <branch name="XLXN_508">
            <wire x2="2640" y1="1440" y2="1440" x1="2608" />
        </branch>
        <instance x="2640" y="1472" name="XLXI_534" orien="R0" />
        <iomarker fontsize="28" x="2176" y="1440" name="Activity" orien="R180" />
        <branch name="Activity_LED">
            <wire x2="2928" y1="1440" y2="1440" x1="2864" />
        </branch>
        <iomarker fontsize="28" x="2928" y="1440" name="Activity_LED" orien="R0" />
    </sheet>
</drawing>